...
b1s0_mat1_g1 = b1s0[0:12:3,4]
b1s0_mat1_g1_error = b1s0[0:12:3,5]

b1s0_mat1_g2 = b1s0[0:12:3,6]
b1s0_mat1_g2_error = b1s0[0:12:3,7]

b1s0_mat2_g1 = b1s0[1:12:3,4]
b1s0_mat2_g1_error = b1s0[1:12:3,5]

b1s0_mat2_g2 = b1s0[1:12:3,6]
b1s0_mat2_g2_error = b1s0[1:12:3,7]

b1s0_mat3_g1 = b1s0[2:12:3,4]
b1s0_mat3_g1_error = b1s0[2:12:3,5]

b1s0_mat3_g2 = b1s0[2:12:3,6]
b1s0_mat3_g2_error = b1s0[2:12:3,7]
...
ax.set_title(r'Scattering XS 2$\rightarrow$1')
...
#ax.set_ylabel('barns ($\sigma$)')
ax.ticklabel_format(useOffset=False)
ax.set_title(r'Scattering XS 2$\rightarrow$2')
ax.annotate("Fuel", xy=(0.1,0.88),xycoords='axes fraction', fontsize=14)
...
plt.savefig('errorbar_s0xsg2.png', dpi=300)
