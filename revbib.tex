...
Essas dificuldades, porém, são inferiores aos possíveis ganhos na utilização de
...
nuclear. Este é muito provavelmente um caminho sem volta. E apesar da abordagem
...
fronteira e posição de diferentes materiais são equivalentes em ambos os modelos.
...
Neste trabalho o problema é tratado como de regime permanente, bem como o problema escopo
desta tese.
...
código termo-hidráulico externo. Atualmente, o Serpent2 conta com uma interface para utilização
