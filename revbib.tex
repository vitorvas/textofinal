...
% Em outras palavras, o acoplamento interno é uma implementação multi-física.
...
%O leitor interessado nos detalhes dos métodos utilizados no \textit{Serpent} na
...
%não varia, mas apenas os valores do fluxo variam com o tempo.
...
%levando-se em consideração os efeitos neutrônicos.
...
Uma das mais utilizadas ferramentas para estudo de segurança de reatores nucleares é o
...
% Os exemplos de tempo investido em sistemas de cálculos acoplados não cessam.
...
Apesar de não ser um sistema \textit{CFD}, mas de elementos finitos, a razão de se
...
%um acoplamento explícito RELAP5/\textit{CFD} e conclui que o \textit{CFD} é capaz de 
...
%programador \cite{OpenFOAM2015b} e a documentação do código 
