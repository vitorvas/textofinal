...
de reatividade. %-temperatura. %\cite[Capítulo~1]{Veloso2005}.
...
A temperatura média nos subcanais foi calculada por Veloso \cite[Capítulo~8]{Veloso2005} com vistas ao licenciamento
...
%brevemente apresentado na seção \ref{sec:triga}.
...
\hline
\begin{tabular}[l]{@{}l@{}}Combustível\\$UZrH$\end{tabular}  & 6280,0                                                               & \begin{tabular}[c]{@{}l@{}}$0,294$+\\ 6,196 x $10^{-4} T-$\\2,748 x $10^{-9} T^2+$\\1,354 x $10^{-11} T^3$\end{tabular}              & \begin{tabular}[c]{@{}l@{}}22,872-\\ 4,3131 x $10^{-2} T +$ \\1,124 x $10^{-4} T^2-$\\1,0039 x $10^{-11} T^3$\end{tabular}              & -                                                                     \\
\hline
\begin{tabular}[l]{@{}l@{}}Revestimento\\Alumínio 110\end{tabular} & 2705,0                                                               & \begin{tabular}[c]{@{}l@{}}$0,892$+\\4,44361 x $10^{-4} T+$\\3,632 x $10^{-8} T^2$\end{tabular}                & \begin{tabular}[c]{@{}l@{}}223,7+\\ 4.756 x $10^{-2}T+$\\ 1,0215 x $10^{-5} T^2-$\\ 1,8887 x $10^{-11} T^3$
  \end{tabular} & -                                                                     \\
\hline
\begin{tabular}[l]{@{}l@{}}Refrigerante\\Água ($20^\circ$C)\end{tabular}        & 995,0                                                                & 4,18                                                                       & 0,62                                                                       & 797                                                                  
\end{tabular}
\end{table}
...
Estas condições descrevem as características iniciais do problema a ser resolvido. Alguns comentários sobre
a tabela \ref{tab:cc-init}: a velocidade na entrada do sistema se baseia na velocidade média do escoamento na
...
Vale ressaltar que o que se convencionou chamar no texto de potência, tal qual implementada no \textit{solver}, é dada em $W/m^3$,
ou seja, é uma densidade de potências volumétrica.
...
como 
%A condição de
%fluxo se limita a fluxo zero na fronteira.
%Esta condição é aplicada utilizando-se
%a palavra-chave
...
Uma explicação objetiva sobre quais são e como estão
...
\begin{table}[htb]
  ...
  \hline
  \multirow{4}{*}{Grupo 1: > 0,625 MeV} & Coeficiente de Difusão & $D_1$\\
...
& Seção de choque de espalhamento & $\Sigma_{S1.2}$\\
  ...
  \hline
\multirow{3}{*}{Grupo 2: < 0,625 MeV} & Coeficiente de difusão & $D_2$\\
...
\begin{tabular}{rlcc}
                              & \multicolumn{1}{c}{Material}                                         & Código & \multicolumn{1}{c}{Densidade atômica} \\ \cline{2-4} 
\multirow{4}{*}{Combustível}  & \begin{tabular}[c]{@{}l@{}}H (no hidreto\\ de zircônio)\end{tabular} & 5001   & 3,7525$\times10^{-02}$           \\
                              & Zr                                                                   & 91     & 3,7727$\times10^{-02}$           \\
                              & U$^{235}$                                            & 2235   & 2,5744$\times10^{-04}$           \\
                              & U$^{238}$                                            & 8238   & 1,0167$\times10^{-03}$           \\ \hline
Revestimento                  & Al                                                                   & 27     & 6,0261$\times10^{-02}$           \\ \hline
\multirow{2}{*}{Refrigerante} & H                                                                    & 3001   & 6,6653$\times10^{-02}$           \\
                              & O                                                                    & 6016   & 3,3327$\times10^{-02}$          
\end{tabular}
\end{table}
...
%  pelo \textit{milonga}, diferindo do usual em relação a maiúsculas, minúsculas e sobrescrito.}
\footnote{Os valores tabelados estão fora das grandezas típicas por terem sido multiplicados por $cm$ ($10^{-2}m$) em razão da malha utilizada
  para os cálculos ter sido definida nesta unidade.}
 \ref{tab:temp-fuel},
...
%  \hline
%  $D_1$ & 0,0108349 & 0,0108521 & 0,0108489 & 0,010846\\
%  $\Sigma_{A1}$ & 0,771135 & 0,783626 & 0,795686 & 0,806567\\
%  $\Sigma_{S1.2}$ & 3,3991 & 3,4329 & 3,4264 & 3,4206\\
%  $\nu \Sigma_{F1}$ & 0,500982 & 0,500304 & 0,500377 & 0,500441\\
%  \hline
%  $D_2$ & 0,00314942 & 0,0031682 & 0, 0032163 & 0,0032743 \\
%  $\Sigma_{A2}$ & 11,0389 & 10,8142 & 10,4004 & 9,90199\\
%  $\nu \Sigma_{F2}$ & 20,1943 & 19,7703 & 18,9898 & 18,0499\\
%  \hline
%\end{tabular}
%\end{table}
%
...
%    \hline
%    $D_1$ & 0,0299644 & 0,0299699 & 0,0299678 & 0,0299659 \\
%    $\Sigma_{A1}$ & 0,0288617 & 0,028926 & 0,0289199 & 0,0289143 \\
%    $\Sigma_{S1.2}$ & 3,3991 & 3,4329 & 3,4264 & 3,4206\\
%    \hline
%    $D_2$ & 0,0376276 & 0,0376721 & 0,0377696 & 0,0379140\\
%    $\Sigma_{A2}$ & 0,874322 & 0,865956 & 0,846858 & 0,818690\\
%    \hline
%  \end{tabular}
%\end{table}
%
...
%    \hline
%    $D_1$ & 0,0126587 & 0,0126685 & 0,0126696 & 0,0126705\\
%    $\Sigma_{A1}$ & 0,0290925 & 0,0292130 & 0,0292018 & 0,0291917\\
%    $\Sigma_{S1.2}$ & 3,3991 & 3,4329 & 3,4264 & 3,4206\\
%    \hline
%    $D_2$ & 0,00213616 & 0,0021262 & 0021368 & 0021589\\
%    $\Sigma_{A2}$ & 1,42651 & 1,41891 & 1,39505 & 1,35409\\
%    \hline
%  \end{tabular}
%\end{table}
%
