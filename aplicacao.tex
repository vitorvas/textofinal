...
propriedades termo-físicas dos respectivos materiais, que são previamente definidas na
modelagem do problema, para o cálculo do fluxo de calor entre as regiões. As propriedades termo-físicas
...
\begin{table}[htb]
\centering
\caption{Propriedades termo-físicas dos materiais em função da temperatura ($T$)}
